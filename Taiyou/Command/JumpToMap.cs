...
{
    public class JumpToMap : TaiyouCommand
    {
        public JumpToMap(string[] pArguments, string pScriptCaller, TaiyouLine pRootTaiyouLine)
        {
        ...
        public override int Call()
        {
            ...
            string MapName = GetArgument(Arguments, 0);
